        ...
        <div className="grid gap-8 md:grid-cols-[2fr_minmax(0,1fr)] md:items-start">
          ...
          <div className="flex flex-col justify-between">
            ...
            <nav className="mt-10 text-xs text-white/70 md:mt-24">
              <ul className="flex flex-wrap gap-x-6 gap-y-3">
                ...
                <li>
                  <a href="#deals" className="hover:text-white">СДЕЛКИ ОНЛАЙН</a>
                </li>
                <li>
                  <a href="#company" className="hover:text-white">О КОМПАНИИ</a>
                </li>
                <li>
                  <a href="#about" className="hover:text-white">TRADEBLADE ЭТО</a>
                </li>
                <li>
          ...
          <div className="flex flex-col items-start justify-between gap-6 md:items-end md:border-l md:border-white/10 md:pl-8">
            ...
            <img
              src={logo}
              alt="TradeBlade logo"
              className="h-14 w-auto drop-shadow-[0_0_25px_rgba(129,140,248,0.6)]"
            />
